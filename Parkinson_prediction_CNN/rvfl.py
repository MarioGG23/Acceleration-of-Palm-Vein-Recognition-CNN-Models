...
if __name__ == "__main__":
    ...
    for i in bins_values:
        ...
        accuracy, tiempo = rvfl(histograms, labels)
        print(f"Precisión usando RVFL con {i} bins en el conjunto de test: {accuracy * 100:.2f}%, Tiempo de entrenamiento: {tiempo:.5f} segundos")